...
function builder(options) {
  ...
  if (!options.network) {
    options.network = quantisnetcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || quantisnetcore.Block;
  options.BlockHeader = options.BlockHeader || quantisnetcore.BlockHeader;
  options.Transaction = options.Transaction || quantisnetcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || quantisnetcore.MerkleBlock;
  options.MnListDiff = options.MnListDiff || quantisnetcore.MnListDiff;
